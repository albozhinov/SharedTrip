...
using SharedTrip.Contracts;
    ...
    public class UserService : IUserService
    {
        ...
        public (bool isValid, IEnumerable<ErrorViewModel> errors) ValidateModel(RegisterViewModel model)
        {
            ...
            {
                isValid = false;
                errors.Add(new ErrorViewModel("User name is required and must be between 5 and 20 characters"));
            }
            ...
            {
                isValid = false;
                errors.Add(new ErrorViewModel("Password and ConfrimPassword are not the same"));
            }
